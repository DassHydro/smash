...
def test_module_parameters():
    ...
    assert list(HYDROLOGICAL_MODULE_RR_INTERNAL_FLUXES.values()) == (
        [["pn", "en", "pr", "perc", "ps", "es", "lexc", "prr", "prd", "qr", "qd", "qt"]] * 3  # % gr4, gr4_mlp, gr4_ri
        + [["pn", "en", "lexc", "qt"]] * 2  # % gr4_ode, gr4_ode_mlp
        + [["pn", "en", "pr", "perc", "ps", "es", "lexc", "prr", "prd", "qr", "qd", "qt"]] * 3  # % gr5, gr5_mlp, gr5_ri
        ...
        * 2  # % grc, grc_mlp
        ...
        + [["ei", "pn", "en", "pr", "perc", "ps", "es", "prr", "prd", "qr", "qd", "qt"]] * 2  # % loieau, loieau_mlp
