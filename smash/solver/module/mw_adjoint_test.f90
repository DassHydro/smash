...
module mw_adjoint_test
    ...
    contains
        ...
        subroutine scalar_product_test(setup, mesh, input_data, parameters, states, output)
            ...
            write(*,'(4x,a,f10.6)') "<dY*, dY> (sp1) = ", output%sp1
            write(*,'(4x,a,f10.6)') "<dk*, dk> (sp2) = ", output%sp2
            write(*,'(4x,a,f10.6)') "Relative Error  = ", (output%sp1 - output%sp2) &
            & / output%sp1
        ...
        subroutine gradient_test(setup, mesh, input_data, parameters, states, output)
            ...
            do n=1, 16
                ...
                write(*,'(4x,a,f10.6,4x,a,f10.6)') "an = ", output%an(n), "|Ia - 1| = ", abs(output%ian(n) - 1)
