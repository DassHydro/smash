...
contains
    ...
    !% TODO comment
    subroutine gr_interception_dev(prcp, pet, ci, hi, pn, ei)
    ...
    end subroutine gr_interception_dev

    subroutine gr_production_dev(pn, en, cp, beta, hp, pr, perc)
    ...
    end subroutine gr_production_dev

    subroutine gr_exchange_dev(exc, hft, l)
    ...
    end subroutine gr_exchange_dev

    subroutine gr_transfer_dev(n, prcp, pr, ct, ht, q)
    ...
    end subroutine gr_transfer_dev

end module md_gr_operator_dev
