...
contains
   ...
   subroutine scalar_product_test(setup, mesh, input_data, parameters, states, output)
      ...
      & parameters_bgd, parameters_bgd_d, parameters_bgd_b
      type(StatesDT) ::  states_d, states_b, &
      & states_bgd, states_bgd_d, states_bgd_b
      ...
      call ParametersDT_initialise(parameters_bgd_d, mesh)
      ...
      call StatesDT_initialise(states_bgd_d, mesh)
