...
!%      ----------
!%
!%      - SetupDT_dev_initialise
!%      - SetupDT_dev_copy

module mwd_setup_dev

    use md_constant_dev !% only: sp, lchar
    ...
    end type SetupDT_dev

contains

    subroutine SetupDT_dev_initialise(this, nd)

        !% Notes
        !% -----
        !% Setup_devDT initialisation subroutine

        implicit none

        type(SetupDT_dev), intent(inout) :: this
    ...
    end subroutine SetupDT_dev_initialise
    
    subroutine SetupDT_dev_copy(this, this_copy)
    
        implicit none
        
        type(SetupDT_dev), intent(in) :: this
        type(SetupDT_dev), intent(out) :: this_copy
        
        this_copy = this
    
    end subroutine SetupDT_dev_copy

end module mwd_setup_dev
