...
module md_simulation
    ...
    use md_gr_operator !% only: gr4_timestep, gr4_mlp_alg_timestep, gr4_ode_timestep, &
    !% & gr4_mlp_ode_timestep, gr5_timestep, grd_timestep, loieau_timestep
...
contains
    ...
    subroutine simulation(setup, mesh, input_data, parameters, output, options, returns)
        ...
        select case (setup%hydrological_module)
            ...
            ! 'gr4' module
        case ("gr4", "gr4_mlp_alg", "gr4_ode", "gr4_mlp_ode")
        ...
        do t = 1, setup%ntime_step
            ...
            case ("gr4_mlp_alg")
                ...
                call gr4_mlp_alg_timestep(setup, mesh, options, parameters%nn_parameters%layers, &
                & parameters%nn_parameters%neurons, prcp, pet, ci, cp, ct, kexc, hi, hp, ht, qt(:, :, zq))
            ...
            case ("gr4_ode")
                ...
                call gr4_ode_timestep(setup, mesh, options, prcp, pet, ci, cp, ct, kexc, hi, hp, ht, qt(:, :, zq))
            ...
            case ("gr4_mlp_ode")
                ...
                call gr4_mlp_ode_timestep(setup, mesh, options, parameters%nn_parameters%layers, &
                & parameters%nn_parameters%neurons, prcp, pet, ci, cp, ct, kexc, hi, hp, ht, qt(:, :, zq))
