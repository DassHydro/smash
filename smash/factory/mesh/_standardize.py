...
def _standardize_generate_rr_mesh_shp_path(shp_path: FilePath | None) -> str | None:
    if shp_path is None:
        return shp_path
...
def _standardize_generate_rr_mesh_args(
    ...
    shp_path = _standardize_generate_rr_mesh_shp_path(shp_path)
    ...
    return flwdir_path, bbox, x, y, area, code, shp_dataset, max_depth, epsg
