...
.. _math_num_documentation.forward_structure.hydrological_module.gr5.ri:
...
.. note::
    ...
    If :math:`\alpha_2 = 0`, we return to the ``gr-4/gr-5`` writting of the transfer, see :ref:`GR4 Transfer <math_num_documentation.forward_structure.hydrological_module.gr4>`.
