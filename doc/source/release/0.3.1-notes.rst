...
.. note::
    ...
    More information can be find in the Math/Num documentation section: :ref:`Cost functions <math_num_documentation.signal_analysis.cost_functions>`.
...
- :ref:`Fully-distributed optimization using a uniform first guess <user_guide.in_depth.optimize.fully_distributed>`
- :ref:`Improving the first guess using Bayesian estimation <user_guide.in_depth.optimize.bayes_estimate>`
- :ref:`Pre-regionalization using polynomial mapping <user_guide.in_depth.optimize.pre_regio_poly>`
- :ref:`Pre-regionalization using artificial neural network <user_guide.in_depth.optimize.pre_regio_ann>`
