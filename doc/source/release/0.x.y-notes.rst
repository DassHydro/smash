...
- :ref:`Variational Bayesian calibration <user_guide.in_depth.optimize.bayes_optimize>`
- :ref:`Multi-criteria optimization <user_guide.in_depth.optimize.multi_criteria>`

Add :ref:`developers guide <developers_guide>`, :ref:`list of contributors <contributors>` and :ref:`license <license>` to the documentation.
...
.. code-block:: python
    ...
    >>> problem = {'num_vars': 1, 'names': ['cp'], 'bounds': [[1,2000]]}
    >>> sr = smash.generate_samples(problem)  # create a SampleResult object
    >>> slc = sr.slice(0,10)  # slice the first 10 set
    >>> for slc in sr.iterslice()  # iterate over the sample in increments of 100
    >>>     slc
...
.. hint::
    See the specific :ref:`User Guide <user_guide.in_depth.multiple_run>` section.
