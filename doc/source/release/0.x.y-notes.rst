...
Note that **mean** is now a dictionary, whereas **backg_sol** used to be a list.

It can be used as follows:

.. code-block:: python

    >>> sr = smash.generate_samples(problem, generator="normal", mean={"cp": 500})

instead of:

.. code-block:: python

    >>> sr = smash.generate_samples(problem, generator="normal", backg_sol=500)
