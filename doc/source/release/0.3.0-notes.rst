...
.. note::
    ...
    More information can be find in the User Guide section: :ref:`Model structure <user_guide.others.model_structure.gr_d>`.
...
.. note::
    ...
    More information can be find in the Math / Num Documentation section :ref:`math_num_documentation.signal_analysis.hydrological_signatures`.
