...
Optimizer algorithm and learning rate can be adjusted if the neural network is not set when using :meth:`Model.ann_optimize`.

.. code-block:: python

    >>> model.ann_optimize(optimizer="sgd", learning_rate=0.01)
