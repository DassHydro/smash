...
The ``learning_rate`` argument is passed to the ``options`` argument of the :meth:`Net.compile` method. 
...
Add the documentation of the different algorithm options using a customize sphinx directive.
